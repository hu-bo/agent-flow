...
`ChatPanel` / `InputArea` ���� `suggestions` �� `onSuggestionSelect`�������ڳ��� prompt ��ݰ�ť��

```tsx
import { ChatPanel, type ChatSuggestion } from '@agent-flow/chat-ui';

const suggestions: ChatSuggestion[] = [
  { label: '/plan', prompt: '���ȸ���ִ�мƻ�', behavior: 'send' },
  { label: '/summary', prompt: '���ܽᵱǰ�ỰҪ��', behavior: 'fill' },
];
...
- `behavior: 'send'`�������ֱ�ӷ��͸ÿ��ָ�
- `behavior: 'fill'`�������ֻ���������û��ɼ����༭���͡�
