...
export interface PlanExecutor {
    execute(plan: AgentPlan, request: AgentRunRequest, session: AgentSession, context: ContextEnvelope, options?: ExecutePlanOptions): AsyncGenerator<AgentEvent, AgentRunResult>;
}
