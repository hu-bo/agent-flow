  ...
  switch (normalizedType) {
    ...
    case 'stdout':
      return {
        ...
        chunkSequence: event.stdout?.chunkSequence,
        byteOffset: event.stdout?.byteOffset,
    ...
    case 'stderr':
      return {
        ...
        chunkSequence: event.stderr?.chunkSequence,
        byteOffset: event.stderr?.byteOffset,
    ...
    case 'completed':
      return {
        ...
        stdoutBytes: event.completed?.stdoutBytes,
        stderrBytes: event.completed?.stderrBytes,
