...
export interface RunnerTaskEventMessage {
  ...
  stdout?: { chunk?: string; chunkSequence?: number | string; byteOffset?: number | string; truncated?: boolean };
  stderr?: { chunk?: string; chunkSequence?: number | string; byteOffset?: number | string; truncated?: boolean };
